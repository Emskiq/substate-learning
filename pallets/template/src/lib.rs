...
pub mod pallet {
    ...
    // Step 4) Possible errors when call has failed
    #[pallet::error]
    pub enum Error<T> {
    ...
    // Step 5) Storage map: key -> value, where claim -> block where the claim points
    #[pallet::storage]
    ...
    impl<T: Config> Pallet<T> {
        ...
        // Step 6) The exposet pallet functions' logic
        #[pallet::weight(Weight::default())]
        #[pallet::call_index(1)]
